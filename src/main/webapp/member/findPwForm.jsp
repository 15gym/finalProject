	...
	<div class="sub-navigation-box nav02">
		...
		<div class="sub-contents-box">
       	<ul class="tab-list-box column2">
       		<li><button type="button" class="btn-tab-item " onclick="location.href='findIdForm'">아이디 찾기</button></li>
        	<li><button type="button" class="btn-tab-item on">비밀번호 찾기</button></li>
        </ul>
			<div class="tab-contents">
            	...
            	본인 명의의 이메일로 <span class="t-gray">본인 인증을 통해,</span><br /><span class="t-gray">비밀번호를 확인</span>하실 수 있습니다.
                    ...
                    <div class="icon-btn-box">
                    	<a href="" onclick="pwFind(); return false;" class="btn xl font-l black pd-xl">이메일 인증하기</a>
                	</div>
            	</div>
			</div>
		</div>
